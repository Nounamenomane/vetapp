            ...
            <>
                ...
                <span>
                    <p>
                        ...
                        Компания «Белека» занимается производством и распространением товаров для фермеров, в том числе они продают
                ...
                <span>
                    <p>
                        Завод «Белека» предлагает полный спектр ветеринарных препаратов по рецепту и без по конкурентоспособным ценам.
                        Также из преимуществ можно выделить:
                    </p>
                </span>
                <div className={styles.text}>
                    <b>-</b>
                    <p>Завод «Белека» предлагает полный спектр ветеринарных препаратов по рецепту и без по конкурентоспособным ценам.
